      ...
      <div class="main-content">
        ...
        <div class="edit-area hidden">
          ...
          <div id="selection-tool">
            <span id="selection-tool-height">0</span>
            <span id="selection-tool-width">0</span>
          </div>
            ...
            <ul class="edit-tools-list">
              <li class="tool-item transform-tool" id="transform">
                ...
                <ul class="options-list transform-list hidden" id="transform-list">
                  <li class="edit-option" id="crop">Show crop area</li>
                  <li class="edit-option" id="crop-done">Apply crop</li>
                ...
                <div class="option-controls resize-option-controls">
                  ...
                  <div class="crop-controls hidden">
                    ...
                    <div class="controls-content">
                      ...
                      <button class="crop-done-btn" disabled></button>
              ...
              <li class="tool-item border-tool" id="border">Border</li>
              <li class="tool-item draw-tool" id="draw">Draw</li>
            </ul>
          </div>
        </div>
      </div>
